...
#define SERVER_TOKEN_LENS 32
#define SERVER_SEED_LENS 32
#define SERVER_UUID_LENS 32
#define SHA256_LENS (256 / 8)
#define SERVER_USERNAME_LENS 20
#define SERVER_CLIENT_UNUSED_TIMEOUT (30 * 60)
#define SERVER_USER_UNUSED_TIMEOUT (2 * 60)
