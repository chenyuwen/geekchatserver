...
server: server.o mysql_connector.o libmethods.a libserver.a libcrypto.a libjansson.a libcrc32.a libhashmap.a
...
libserver.a: packet.o users.o mysql_connector.o random_pool.o mlog.o tokens.o friends.o
	ar -r $@ $^
